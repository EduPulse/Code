        ...
        <div className={useStyles().root}>
          <Grid container spacing={2} className={useStyles().pubPostInfo}>
            <Grid item xs className={useStyles().postsInfo}>
                <Button aria-label="recipe" className={useStyles().buttonStyle} onClick={() => { setAll("block"); setComment("none"); setPost("none"); setReaction("none"); }}>
                    All Notifications
                </Button>

              <Button aria-label="recipe" className={useStyles().buttonStyle} onClick={() => { setAll("none"); setComment("none"); setPost("block"); setReaction("none"); }}>
                Publications
              </Button>

              <Button aria-label="recipe" className={useStyles().buttonStyle} onClick={() => { setAll("none"); setComment("block"); setPost("none"); setReaction("none"); }}>
                Comments
              </Button>

              <Button aria-label="recipe" className={useStyles().buttonStyle} onClick={() => { setAll("none"); setComment("none"); setPost("none"); setReaction("block"); }}>
                Reactions
              </Button>
            </Grid>
