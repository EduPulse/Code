        ...
        <div className={classes.root}>
            {/* <Card>
                ...
                <CardContent>
                    ...
                    <Typography>
                        We are EduPulse, a resource sharing platform for educators.
                    </Typography>
                </CardContent>
            </Card> */}
            <Card className={classes.mainClass}>
                <div>
                    ...
                    {/* <Card className={classes.introCard1}>
                        <Typography className={classes.heading}>
                            The Heart of the Learning Community
                        </Typography>
                            ...
                            <Grid item xs={2}>
                                <Card>
                                    ...
                                    <CardContent>
                                        ...
                                        {/* <Typography variant="body2" color="text.secondary" align="center">We are team EduPulse</Typography> */}
                                        {/* edupulse27@gmail.com */}
                                    </CardContent>
                                </Card>
                            </Grid>
                        </Grid>
