...
import {Button, ButtonBase, Dialog, DialogActions, DialogContent, DialogTitle, Divider, FormControl, FormHelperText, FormLabel, Grid, Hidden, IconButton, List, Paper, TextField, Typography } from "@material-ui/core";
import { BusinessRounded, LanguageRounded, MailOutline, PhoneRounded, AddRounded, RemoveRounded, EmailRounded, EditRounded } from '@material-ui/icons';
                ...
                <div>
                    ...
                    <Grid container spacing={1} className={classes.contactContainer}>
                        <Grid item xs={4} className={classes.statContainer}>
                            <Typography color='primary' variant='h4' align='center'><Skeleton variant="text" width="5vw" /></Typography>
                            <Typography variant='subtitle2' align='center'><Skeleton variant="text" width="4vw" /></Typography>
                        </Grid>
                        <Grid item xs={4} className={classes.statContainer}>
                            <Typography color='primary' variant='h4' align='center'><Skeleton variant="text" width="5vw" /></Typography>
                            <Typography variant='subtitle2' align='center'><Skeleton variant="text" width="4vw" /></Typography>
                    ...
                    <Grid container spacing={1} className={classes.contactContainer}>
                        ...
                        <Grid item xs={6} className={classes.contact}>
                            <div className={classes.contactContent}>
                                <Skeleton variant="rect" width={32} height={32} className={classes.m1} style={{alignSelf: 'start'}}/>
                                <div style={{display: 'flex', flexDirection: 'column'}}>
                                    <Skeleton variant="text" width="8vw" />
                                    <Skeleton variant="text" width="8vw" />
                                    <Skeleton variant="text" width="8vw" />
            ...
            <>
                <Paper className={classes.root}>
                    <div style={{height: '20vh', width: '100%', overflow: 'hidden'}}>
                        <img src={info.coverImage} style={{height: 'auto', maxWidth: '100%', backgroundSize: 'cover', backgroundPosition: 'center'}} />
                    </div>
                    <div>
                        <Typography variant='h5' align='left' className={classes.body}>
                            {info.name}
                        ...
                        <Grid container spacing={1} className={classes.contactContainer}>
                            <Grid item xs={4} className={classes.statContainer}>
                                <Typography color='primary' variant='h4' align='center'>{convertNumber(info.stats.noUsers)}</Typography>
                                <Typography variant='subtitle2' align='center'>members</Typography>
                            </Grid>
                            <Grid item xs={4} className={classes.statContainer}>
                                <Typography color='primary' variant='h4' align='center'>{convertNumber(info.stats.noPosts)}</Typography>
                                <Typography variant='subtitle2' align='center'>posts</Typography>
                            </Grid>
                            <Grid item xs={4} className={classes.statContainer}>
                                <Typography color='primary' variant='h4' align='center'>{convertNumber(info.stats.noViews)}</Typography>
                        ...
                        <Grid container spacing={1} className={classes.contactContainer}>
                            ...
                            <Grid item xs={6} className={classes.contact}>
                                <div className={classes.contactContent}>
                                    ...
                                    <div style={{display: 'flex', flexDirection: 'column'}}>
                                        <Typography variant="subtitle2" align="left">{info.contactDetails.address.line1},</Typography>
                                        <Typography variant="subtitle2" align="left">{info.contactDetails.address.line2},</Typography>
                                        <Typography variant="subtitle2" align="left">{info.contactDetails.address.city},</Typography>
                                        <Typography variant="subtitle2" align="left">{info.contactDetails.address.country}</Typography>
                                    </div>
                                </div>
                            </Grid>
                        </Grid>
                        <Button variant="text" color="primary" className={classes.m1} onClick={() => setOpen(true)}>Update Info</Button>
                    </div>
                </Paper>
                <Snackbar open={alert.open} message={alert.message} type={alert.type} close={() => {
                    const tempAlert = alert;
