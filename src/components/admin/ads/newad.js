...
function Newad() {
    ...
    const [adForm, setAdForm] = useState({clientName:'',phone:'',email:'',advertType:'',adpackage:0,startDate:'',endDate:'',redirectLink:'',description:''})
    ...
    const handleSubmit = (e)=>{
      ...
      .then(function (response) {
        ...
        setAdForm({clientName:'',phone:'',email:'',advertType:'',adpackage:0,startDate:'',endDate:'',redirectLink:'',description:''})
        setfiles(null)
      })
      .catch(function (err) {
        //handle error
