...
const AddModerator = () => {
    ...
    return (
        <div>
            <Button variant="contained" color="primary" className={classes.Newbutton} onClick={handleOpen}>Add New Moderator +</Button>
            ...
            >
                ...
                <div className={classes.paper}>
                    <form className={classes.root} noValidate autoComplete="off" onSubmit={handleSubmit}>
                        ...
                        <center>
                            <Button variant="contained" color="primary" className={classes.submitbutton} type="submit"> Submit </Button>
                        </center>
